...
{
	if(strcmp(a->guid,      b->guid) == 0 && strcmp(a->guid, "guid") != 0)
		return qtrue;

	if(strcmp(a->ip,        b->ip) == 0 && strcmp(a->ip, "ip") != 0)
		return qtrue;

	if(strcmp(a->adminName, b->adminName) == 0 && strcmp(a->adminName, "noname") != 0)
		return qtrue;
